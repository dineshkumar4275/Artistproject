...
// import Contact from './components/Contact';
// import Admin from './components/Admin';
// import PhotographyAdmin from './components/PhotographyAdmin';
// import Login from './components/Login';
// import Loading from './components/Loading';
// import ToastProvider from './components/ToastProvider';
// import SEO from './components/SEO';
...
//   if ((currentPageName === 'admin' || currentPageName === 'photography-admin') && !isAdminLoggedIn) {
//     return (
//       <div className="app">
//         <Helmet>
//           <title>Admin Login - FRAMORA</title>
...
//             <Route path="/home" element={<Home images={images} setCurrentPage={handlePageChange} />} />
//             <Route path="/gallery" element={<Gallery images={images} />} />
//             {/* ===== IMPORTANT: Pass photographyImages to Photography ===== */}
...
import Contact from './components/Contact';
import Admin from './components/Admin';
// ❌ Remove this line - PhotographyAdmin doesn't exist
import PhotographyAdmin from './components/PhotographyAdmin';
import Login from './components/Login';
import Loading from './components/Loading';
import ToastProvider from './components/ToastProvider';
...
function App() {
  // Gallery images (URL uploads)
  const { images, loading, addImageFromUrl, removeImage, clearAllImages } = useImages();
  
  // Photography images (Cloudinary uploads)
  const { 
    photographyImages, 
    photographyLoading, 
    addPhotographyImage, 
