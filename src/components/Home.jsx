  ...
  const socialLinks = [
    {
      name: 'Instagram',
      icon: FaInstagram,
      url: 'https://www.instagram.com/urbaninkpen?igsh=MTlwbDgzdDgxd2xyMQ%3D%3D&utm_source=qr',
      color: '#E4405F'
    },
    {
      name: 'WhatsApp',
    ...
    },
    {
      name: 'Behance',
      icon: FaBehance,
      url: 'https://www.behance.net/kameshfineart',
      color: '#1769FF'
    },
    {
      name: 'LinkedIn',
      icon: FaLinkedin,
      url: 'https://www.linkedin.com/in/kamesh-p-a89abb267?utm_source=share_via&utm_content=profile&utm_medium=member_android',
      color: '#0A66C2'
    }
  ];
